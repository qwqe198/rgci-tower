...
control.prototype.speedUpReplay = function () {
    if (!core.isPlaying() || !core.isReplaying()) return;
    var speeds = [0.2, 0.5, 1, 2, 3, 6, 12, 30];
...
control.prototype._resize_statusBar = function (obj) {
    ...
    // 自绘状态栏
    if (core.domStyle.isVertical) {
        core.dom.statusCanvas.style.width = obj.CANVAS_WIDTH * core.domStyle.scale-2 + "px";
        core.dom.statusCanvas.style.height = obj.statusBarHeightInVertical - 5 + "px";
        core.maps._setHDCanvasSize(core.dom.statusCanvasCtx, obj.CANVAS_WIDTH, obj.col * 32 + 9);
    }
    else {
        core.dom.statusCanvas.style.width = obj.BAR_WIDTH * core.domStyle.scale-2 + "px";
        core.dom.statusCanvas.style.height = obj.outerSize - 2 * obj.BORDER +  (obj.extendToolbar ? obj.TOOLBAR_HEIGHT * core.domStyle.scale + obj.BORDER-2 : 0) + "px";

var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		core.setFlag('zbjzy', Math.floor(Math.max(core.getFlag('pbjzy', 1), 1) * (core.getFlag('sjbjzy', 1), 1) * (core.itemCount("I848") >= 1 ? 10 : 1) * (core.itemCount("I848") >= 4 ? (core.itemCount("I848") - 2) : 1)) / 10);

var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		core.setFlag('lvsyzy', Math.floor(Math.max(Math.pow((Math.max(core.getFlag('flv', 1) - 97, 0) / 3), core.getFlag('syexp', 0.5)), 0)));
		core.setFlag('psyzy', Math.floor(Math.max(Math.pow((Math.max(Math.log10(core.getFlag('yn', 1) / 5000) / Math.log10(2), 0)), core.getFlag('syexp', 0.5)), 0)));
		...
		core.setFlag('zbjzy', Math.floor(Math.max(core.getFlag('pbjzy', 1), 1) * Math.max(core.getFlag('sybjzy', 1), 1) * (core.itemCount("I848") >= 6 ? 2 : 1) * Math.max(core.getFlag('sjbjzy', 1), 1) * (core.itemCount("I848") >= 1 ? 10 : 1) * (core.itemCount("I848") >= 4 ? (core.itemCount("I848") - 2) : 1)));

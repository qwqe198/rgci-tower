var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		core.setFlag('zgtzy', Math.floor(Math.max(core.getFlag('ggtzy1', 1), 1) * Math.max(core.getFlag('bjgtzy', 1), 1) * Math.max(core.getFlag('fcgtzy', 1), 1) * (core.getFlag('cn', 0) >= 1 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('pgtzy', 1), 1) * Math.max(core.getFlag('hbqgtzy', 1), 1) * Math.max(core.getFlag('gtgtzy', 1), 1) * Math.max(core.getFlag('ggtzy', 1), 1) * Math.max(core.getFlag('sjgtzy', 1), 1) * Math.max(core.getFlag('cctz2', 0) + 1, 1) / 2e+9));

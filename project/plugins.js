var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		//同步基础资源
		core.setFlag('zczy', Math.floor(Math.pow(Math.pow(Math.pow(core.getFlag('gczy', 1) * Math.max(core.getFlag('ynczy', 1), 1) * (core.getFlag('cn', 0) >= 1e+6 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('sjtz2', 0) + 1, 1) * (core.itemCount("I848") >= 1 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('fcczy', 1), 1) * Math.max(core.getFlag('syfczy', 1), 1) * Math.max(core.getFlag('pczy', 1), 1) * Math.pow(core.getFlag('gcfw', 1), 2) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjczy', 1), 1) * Math.max(core.getFlag('hbqczy', 1), 1) * Math.max(core.getFlag('sjczy', 1), 1), 1 - core.getFlag('jrsjtz2', 0) / 5), 1 - core.getFlag('jrcctz2', 0) / 5), 1 - core.getFlag('jrcctz3', 0) / 5)));
		core.setFlag('zjyzy', Math.floor(Math.pow(Math.pow(Math.pow(core.getFlag('gjyzy', 1) * Math.pow(herohp + 1, Math.max(core.getFlag('lvexp', 0), 0)) * Math.max(core.getFlag('syfjyzy', 1), 1) * Math.max(core.getFlag('ynjyzy', 1), 1) * Math.max(core.getFlag('fcjyzy', 1), 1) * (core.getFlag('cn', 0) >= 100 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('sjtz1', 0) + 1, 1) * (core.itemCount("I848") >= 2 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('pjyzy', 1), 1) * Math.max(core.getFlag('bjjyzy', 1), 1) * Math.max(core.getFlag('sjjyzy', 1), 1) * Math.max(core.getFlag('jceff', 1), 1), 1 - core.getFlag('jrsjtz2', 0) / 5), 1 - core.getFlag('jrcctz2', 0) / 5), 1 - core.getFlag('jrcctz3', 0) / 5)));
		...
		core.setFlag('zbjzy', Math.floor(Math.max(core.getFlag('pbjzy', 1), 1) * Math.max(core.getFlag('sybjzy', 1), 1) * (core.itemCount("I848") >= 6 ? 2 : 1) * Math.max(core.getFlag('sjbjzy', 1), 1) * (core.itemCount("I848") >= 1 ? 10 : 1) * (core.getFlag('cn', 0) >= 1e+14 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10) - 13, core.getFlag('cnll', 1)) : 1) * (core.itemCount("I848") >= 4 ? (core.itemCount("I848") - 2) : 1)));
		core.setFlag('zsjzy', Math.floor(Math.pow(Math.pow(Math.max(core.getFlag('lvsjzy', 1), 0) * Math.max(core.getFlag('pzsjzy', 1), 0), Math.max(core.getFlag('sjexp', 0.5), 0)) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('sjsjzy', 1), 1) * (core.getFlag('cn', 0) >= 1e+9 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('hbqsjzy', 1), 1) * Math.max(core.getFlag('gtsjzy', 1), 1) * Math.max(core.getFlag('cctz1', 1) + 1, 1) * Math.max(core.getFlag('bjsjzy', 1), 1) * (1 - core.getFlag('jrcctz1', 0)), 1 - core.getFlag('jrcctz2', 0) / 5)));
		core.setFlag('zjczy', Math.floor(Math.pow(core.getFlag('gjczy', 1) * Math.max(core.getFlag('syjczy', 1), 1) * (core.getFlag('cn', 0) >= 1e+5 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('pjczy', 1), 1) * Math.max(core.getFlag('hbqjczy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('sjjczy', 1), 1) * (core.itemCount("I848") >= 3 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('bjjczy', 1), 1), 1 - core.getFlag('jrcctz2', 0) / 5)));
		core.setFlag('zgtzy', Math.floor(Math.max(core.getFlag('ggtzy1', 1), 1) * Math.max(core.getFlag('sygtzy', 1), 1) * Math.max(core.getFlag('yngtzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjgtzy', 1), 1) * Math.max(core.getFlag('fcgtzy', 1), 1) * (core.getFlag('cn', 0) >= 1 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('pgtzy', 1), 1) * Math.max(core.getFlag('hbqgtzy', 1), 1) * Math.max(core.getFlag('gtgtzy', 1), 1) * Math.max(core.getFlag('ggtzy', 1), 1) * Math.max(core.getFlag('sjgtzy', 1), 1) * Math.max(core.getFlag('cctz2', 0) + 1, 1) / 2e+9));

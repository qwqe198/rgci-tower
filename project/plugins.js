var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		core.setFlag('lvsyzy', Math.floor(Math.max((Math.max(core.getFlag('flv', 1) - 97, 0) / 3), 0)));
		core.setFlag('ynsyzy', Math.floor(Math.max(Math.max(Math.log10(core.getFlag('yn', 1) / 5000) / Math.log10(2), 0), 0)));
		...
		core.setFlag('sjgtzy', Math.max(Math.pow(heromdef, 0.6), 0))
		//同步基础资源
		core.setFlag('zczy', Math.floor(Math.pow(Math.pow(Math.pow(core.getFlag('gczy', 1) * Math.max(core.getFlag('ynczy', 1), 1) * (core.getFlag('cn', 0) >= 1e+6 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('sjtz2', 0) + 1, 1) * (core.itemCount("I848") >= 1 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('fcczy', 1), 1) * Math.max(core.getFlag('syfczy', 1), 1) * Math.max(core.getFlag('hjrlczy', 1), 1) * Math.max(core.getFlag('pczy', 1), 1) * Math.pow(core.getFlag('gcfw', 1), 2) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjczy', 1), 1) * Math.max(core.getFlag('hbqczy', 1), 1) * Math.max(core.getFlag('sjczy', 1), 1), 1 - core.getFlag('jrsjtz2', 0) / 5), 1 - core.getFlag('jrcctz2', 0) / 5), 1 - core.getFlag('jrcctz3', 0) / 5)));
		core.setFlag('zjyzy', Math.floor(Math.pow(Math.pow(Math.pow(core.getFlag('gjyzy', 1) * Math.pow(herohp + 1, Math.max(core.getFlag('lvexp', 0), 0)) * Math.max(core.getFlag('syfjyzy', 1), 1) * Math.max(core.getFlag('ynjyzy', 1), 1) * Math.max(core.getFlag('fcjyzy', 1), 1) * (core.getFlag('cn', 0) >= 100 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('hjrljyzy', 1), 1) * Math.max(core.getFlag('sjtz1', 0) + 1, 1) * (core.itemCount("I848") >= 2 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('pjyzy', 1), 1) * Math.max(core.getFlag('bjjyzy', 1), 1) * Math.max(core.getFlag('sjjyzy', 1), 1) * Math.max(core.getFlag('jceff', 1), 1), 1 - core.getFlag('jrsjtz2', 0) / 5), 1 - core.getFlag('jrcctz2', 0) / 5), 1 - core.getFlag('jrcctz3', 0) / 5)));
		core.setFlag('zpzy', Math.floor(Math.pow(Math.max(Math.max(core.getFlag('lvpzy', 1), 1) * Math.max(core.getFlag('hjrlpzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('gtpzy', 1), 1) * Math.max(core.getFlag('hbqpzy', 1), 1) * Math.max(core.getFlag('ppzy', 1), 1) * (core.getFlag('cn', 0) >= 1e+8 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('bjpzy', 1), 1) * Math.max(core.getFlag('sjpzy', 1), 1) * (1 - core.getFlag('jrsjtz3', 0)) * (1 - core.getFlag('jrcctz3', 0))), 1 - core.getFlag('jrcctz2', 0) / 5)));
		core.setFlag('zbjzy', Math.floor(Math.max(core.getFlag('pbjzy', 1), 1) * Math.max(core.getFlag('hjrlbjzy', 1), 1) * Math.max(core.getFlag('sybjzy', 1), 1) * (core.itemCount("I848") >= 6 ? 2 : 1) * Math.max(core.getFlag('sjbjzy', 1), 1) * (core.itemCount("I848") >= 1 ? 10 : 1) * (core.getFlag('cn', 0) >= 1e+14 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10) - 13, core.getFlag('cnll', 1)) : 1) * (core.itemCount("I848") >= 4 ? (core.itemCount("I848") - 2) : 1)));
		core.setFlag('zsjzy', Math.floor(Math.pow(Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('sjsjzy', 1), 1) * Math.max(core.getFlag('hjrlsjzy', 1), 1) * (core.getFlag('cn', 0) >= 1e+9 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('hbqsjzy', 1), 1) * Math.max(core.getFlag('gtsjzy', 1), 1) * Math.max(core.getFlag('cctz1', 1) + 1, 1) * Math.max(core.getFlag('bjsjzy', 1), 1) * Math.pow(Math.max(core.getFlag('lvsjzy', 1), 0) * Math.max(core.getFlag('pzsjzy', 1), 0), Math.max(core.getFlag('sjexp', 0.5), 0)) * (1 - core.getFlag('jrcctz1', 0)), 1 - core.getFlag('jrcctz2', 0) / 5)));
		core.setFlag('zjczy', Math.floor(Math.pow(core.getFlag('gjczy', 1) * Math.max(core.getFlag('syjczy', 1), 1) * Math.max(core.getFlag('hjrljczy', 1), 1) * (core.getFlag('cn', 0) >= 1e+5 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('pjczy', 1), 1) * Math.max(core.getFlag('hbqjczy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('sjjczy', 1), 1) * (core.itemCount("I848") >= 3 ? core.itemCount("I848") * 4 + 1 : 1) * Math.max(core.getFlag('bjjczy', 1), 1), 1 - core.getFlag('jrcctz2', 0) / 5)));
		core.setFlag('zgtzy', Math.floor(Math.max(core.getFlag('ggtzy1', 1), 1) * Math.max(core.getFlag('hjrlgtzy', 1), 1) * Math.max(core.getFlag('sygtzy', 1), 1) * Math.max(core.getFlag('yngtzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjgtzy', 1), 1) * Math.max(core.getFlag('fcgtzy', 1), 1) * (core.getFlag('cn', 0) >= 1 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10), core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('pgtzy', 1), 1) * Math.max(core.getFlag('hbqgtzy', 1), 1) * Math.max(core.getFlag('gtgtzy', 1), 1) * Math.max(core.getFlag('ggtzy', 1), 1) * Math.max(core.getFlag('sjgtzy', 1), 1) * Math.max(core.getFlag('cctz2', 0) + 1, 1) / 2e+9));
		core.setFlag('zcnzy', Math.floor(Math.pow(Math.max(core.getFlag('pcnzy', 1), 1) * Math.max(core.getFlag('hjrlcnzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjcnzy', 1), 1) * Math.max(core.getFlag('fccnzy', 1), 1) * Math.max(core.getFlag('gccnzy', 1), 1) * Math.max(core.getFlag('hbqcnzy', 1), 1) * Math.max(core.getFlag('yncnzy', 1), 1) * Math.max(core.getFlag('sjcnzy', 1), 1) * (core.itemCount("I848") >= 15 ? core.itemCount("I848") - 13 : 1), core.getFlag('cctz3', 0) * 0.01 + 1)));
		//反资源
		...
		core.setFlag('zynzy', Math.floor((Math.max(core.getFlag('lvynzy', 1), 1) * Math.max(core.getFlag('hjrlynzy', 1), 1) * Math.max(core.getFlag('syynzy', 1), 1) * (core.getFlag('cn', 0) >= 1e+11 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10) - 10, core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjynzy', 1), 1))));
		core.setFlag('zsyzy', Math.floor((core.getFlag('cn', 0) >= 1e+13 ? Math.pow(Math.log10(core.getFlag('cn', 0) + 10) - 12, core.getFlag('cnll', 1)) : 1) * Math.max(core.getFlag('hjrlsyzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjsyzy', 1), 1) * Math.pow(Math.max(core.getFlag('lvsyzy', 1), 0) * Math.max(core.getFlag('ynsyzy', 1), 0), core.getFlag('syexp', 0.5))));
		core.updateStatusBar(true);
	}, 50);
},
    "每秒获取": function a() {

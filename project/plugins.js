var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
	...
	setInterval(function () {
		...
		core.setFlag('zcnzy', Math.floor(Math.pow(Math.max(core.getFlag('pcnzy', 1), 1) * Math.max(core.getFlag('hjrlcnzy', 1), 1) * Math.max(core.getFlag('dcjl', 1), 1) * Math.max(core.getFlag('bjcnzy', 1), 1) * Math.max(core.getFlag('fccnzy', 1), 1) * Math.max(core.getFlag('hbqcnzy', 1), 1) * Math.max(core.getFlag('yncnzy', 1), 1) * Math.max(core.getFlag('sjcnzy', 1), 1) * (core.itemCount("I848") >= 15 ? core.itemCount("I848") - 13 : 1), core.getFlag('cctz3', 0) * 0.01 + 1)));
		//反资源
